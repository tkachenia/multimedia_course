...
lection6.make <- function() {
     writePNG("01.png", func = plot.gen.sin, arg_list = list(100, amp = 0.9, draw_ox = TRUE))
     writePNG("02.png", func = plot.gen.const, arg_list = list(0.75, draw_ox = TRUE))
     writePNG("03.png", func = plot.gen.square, arg_list = list(100, amp = 0.9, draw_ox = TRUE))
     writePNG("04.png", func = plot.gen.square, arg_list = list(100, amp = 0.9, draw_ox = TRUE, draw_pattern_sin = TRUE))
     ...
     # Дескретизация
     writePNG.open("10_1.png", func = plot.gen.sin, arg_list = list(100, title ="Дескретизация"))
     for (i in 0:30)
     ...
     # Квантование
     writePNG.open("10_2.png", func = plot.gen.sin, arg_list = list(100, title ="Квантование"))
     for (i in 0:15)
     ...
     writePNG.open("14.png", func = plot.gen.sin, arg_list = list(100, title ="Квантование", type = "n"))
     for (i in 0:30) {
     ...
     writePNG.open("15.png", func = plot.gen.sin, arg_list = list(100, draw_pattern_sin = TRUE, title ="АЦП", draw_ox = TRUE, type = "n"))
     for (i in 0:30) {
     ...
     # ЦАП
     writePNG.open("16.png", func = plot.gen.sin, arg_list = list(100, title ="ЦАП", draw_ox = TRUE, type = "n"))
     ...
     writePNG.open("17.png", func = plot.gen.sin, arg_list = list(100, draw_pattern_sin = TRUE, title ="ЦАП", draw_ox = TRUE, type = "n"))
     ...
     writePNG.open("18.png", func = plot.gen.sin, arg_list = list(100, draw_pattern_sin = TRUE, title ="ЦАП", draw_ox = TRUE, type = "n"))
